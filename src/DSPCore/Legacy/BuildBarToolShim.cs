...
/// <summary>
/// 旧 BuildBarTool 兼容入口；请迁移到 DSPCore.BuildBar。
/// Legacy BuildBarTool compatibility entry point; migrate to DSPCore.BuildBar.
/// </summary>
...
public static class BuildBarTool
{
    ...
    [System.Obsolete("Use DSPCore.BuildBar.BindItem(tab, row, index, itemId) instead.")]
    public static bool SetBuildBar(int category, int index, int itemId, bool isTopRow)
    {
        return DSPCore.BuildBar.BindItem(category, isTopRow ? 2 : 1, index, itemId);
    }
}
