...
/// <summary>
/// 旧 BuildBarTool 兼容入口；请迁移到 ItemProto.SetBuildBar 或 DSPCore.BuildBar。
/// Legacy BuildBarTool compatibility entry point; migrate to ItemProto.SetBuildBar or DSPCore.BuildBar.
/// </summary>
...
public static class BuildBarTool
{
    ...
    [System.Obsolete("Use ItemProto.SetBuildBar(tab, row, index) or DSPCore.BuildBar.SetBuildBar(tab, row, index, itemId) instead.")]
