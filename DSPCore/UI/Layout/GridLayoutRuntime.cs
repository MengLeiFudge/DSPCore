...
internal static class GridLayoutRuntime {
    ...
    public static void BuildRoot(UiWindow wnd, RectTransform parent, LayoutGrid root) {
    ...
    public static void BuildChildren(UiWindow wnd, RectTransform parent, LayoutRect rect,
