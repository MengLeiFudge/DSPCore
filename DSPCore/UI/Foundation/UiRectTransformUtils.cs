...
public static class UiRectTransformUtils {
    ...
    public static void SetPosition(this UiSlider slider, float x, float y) {
    ...
    /// <param name="totalPx">可用总宽度（像素）。默认内容区宽度为 1082。</param>
    ...
    public static void SetText(this UIButton btn, string notTranslateStr) {
        try {
            ...
            DspCore.Logger?.LogError($"SetText error: {ex}");
        }
    }
}
