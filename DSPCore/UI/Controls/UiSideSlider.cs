...
// UiSlider modified from LSTM: https://github.com/hetima/DSP_LSTM/blob/main/LSTM/UiSlider.cs
/// <summary>
/// 用于侧栏设置项的文本滑条控件。
/// </summary>
public class UiSideSlider : MonoBehaviour {
    ...
    public static UiSideSlider CreateSlider(float x, float y, RectTransform parent, float value, float minValue,
    ...
    public UiSideSlider WithValue(float value) {
        Value = value;
        return this;
    }

    public UiSideSlider WithMinMaxValue(float min, float max) {
        slider.minValue = min;
        slider.maxValue = max;
        return this;
    }

    public UiSideSlider WithLabelFormat(string format) {
    ...
    public UiSideSlider WithFontSize(int fontSize) {
        labelText.fontSize = fontSize;
        return this;
    }

    public UiSideSlider WithEnable(bool on) {
        SetEnable(on);
        return this;
    }
