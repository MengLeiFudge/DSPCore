...
public class UiCheckButton : MonoBehaviour {
    ...
    public static UiCheckButton CreateCheckButton(float x, float y, RectTransform parent, ConfigEntry<bool> config,
        string label = "", int fontSize = 15) {
        return CreateCheckButton(x, y, parent, config.Value, label, fontSize).WithConfigEntry(config);
    }

    public static UiCheckButton CreateCheckButton(float x, float y, RectTransform parent, bool check, string label = "",
        int fontSize = 15) {
        return CreateCheckButton(x, y, parent, fontSize).WithCheck(check).WithLabelText(label);
    }

    public static UiCheckButton CreateCheckButton(float x, float y, RectTransform parent, int fontSize = 15) {
        var go = Instantiate(_baseObject);
        go.name = "dspcore-check-button";
        go.SetActive(true);
        var cb = go.AddComponent<UiCheckButton>();
    ...
    public UiCheckButton WithLabelText(string val) {
        SetLabelText(val);
        return this;
    }
    ...
    public UiCheckButton WithSize(float width, float height) {
    ...
    public UiCheckButton WithIconWidth(float width) {
    ...
    public UiCheckButton WithIcon(Sprite sprite = null) {
        if (icon == null) {
    ...
    public UiCheckButton WithTip(string tip, float delay = 1f) {
    ...
    public UiCheckButton WithCheck(bool check) {
        Checked = check;
        return this;
    }

    public UiCheckButton WithConfigEntry(ConfigEntry<bool> config) {
