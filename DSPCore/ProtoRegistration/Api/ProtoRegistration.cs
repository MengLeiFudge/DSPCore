...
public static class ProtoRegistration
{
    ...
    {
        DspCore.ProtoRegistration.Data(ownerModGuid, configure, priority, purpose);
    }
    ...
    {
        DspCore.ProtoRegistration.DataUpdates(ownerModGuid, configure, priority, purpose);
    }
    ...
    {
        DspCore.ProtoRegistration.DataFinalFixes(ownerModGuid, configure, priority, purpose);
    }
    ...
    {
        DspCore.ProtoRegistration.RegisterPhaseAction(ownerModGuid, phase, configure, priority, purpose);
    }
