...
public static class GridDsl {
    ...
    public static LayoutLeaf Node((int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
        ...
        string objectName = "layout-node", Action<UiWindow, RectTransform> build = null) {
        return new() {
            Pos = pos,
            Span = span,
            Row = row,
    ...
    public static LayoutGrid ContentCard((int, int)? pos = null, (int, int)? span = null, int? row = null,
        ...
        LayoutInsets userPadding = padding ?? new LayoutInsets(UiPageLayout.CardInnerPadding);
        LayoutInsets actualPadding = strong
            ? new LayoutInsets(userPadding.Left + UiPageLayout.StrongAccentWidth + 9f, userPadding.Top, userPadding.Right,
                userPadding.Bottom)
            : userPadding;
        return new() {
            Pos = pos,
            ...
            Children = children ?? Array.Empty<LayoutNode>(),
            OnBuilt = onBuilt,
            RootFactory = (parent, rect) => UiPageLayout.CreateContentCard(parent, objectName, rect.Left, rect.Top,
                rect.Width,
                rect.Height, strong),
        };
    }
    ...
    /// </summary>
    public static LayoutLeaf TextNode(string text, int fontSize = UiPageLayout.BodyFontSize, Color? color = null,
        ...
        return new() {
            ...
            BuildAction = (wnd, parent) => {
                Text built = UiPageLayout.AddCenteredText(parent, text, fontSize,
    ...
    public static LayoutGrid ScrollableContentCard(float contentHeight, (int, int)? pos = null,
        ...
        return new() {
            ...
            OnBuilt = onBuilt,
            RootFactory = (parent, rect) => UiPageLayout.CreateScrollableContentCard(parent, objectName, rect.Left,
    ...
    public static LayoutGrid FooterCard((int, int)? pos = null, (int, int)? span = null, int? row = null,
        ...
        LayoutInsets actualPadding = padding ?? new LayoutInsets(UiPageLayout.CardInnerPadding);
        return new() {
            Pos = pos,
            Span = span,
            Row = row,
    ...
    public static LayoutLeaf Header(string title, string summary = "", string objectName = "page-header",
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null, int? rowSpan = null,
        int? colSpan = null, Action<UiPageLayout.HeaderRefs> onBuilt = null) {
        return new() {
            Pos = pos,
            Span = span,
            Row = row,
    ...
    /// </summary>
    public static LayoutLeaf CardTitleNode(string title, int fontSize = UiPageLayout.CardTitleFontSize,
        ...
        return new() {
            ...
            BuildAction = (wnd, root) => {
                Text text = UiPageLayout.AddCenteredText(root, title, fontSize,
    ...
    public static LayoutLeaf ButtonNode(string text, UnityAction onClick = null,
        int fontSize = UiPageLayout.BodyFontSize, Action<UIButton> onBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    public static LayoutLeaf LabeledComboBoxNode(string label, string[] items, ConfigEntry<int> config,
        int fontSize = UiPageLayout.BodyFontSize, Action<UiComboBox> onBuilt = null,
    ...
    public static LayoutLeaf LabeledComboBoxNode(string label, string[] items, int selectedIndex,
        Action<int> onSelChanged, int fontSize = UiPageLayout.BodyFontSize, Action<UiComboBox> onBuilt = null,
        string tipTitle = null, string tipContent = null, Action<UIButton> onTipBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
        int? rowSpan = null, int? colSpan = null, string objectName = "labeled-combo-node") {
        return new() {
    ...
    public static LayoutLeaf ComboBoxNode(int fontSize = UiPageLayout.BodyFontSize, Action<UiComboBox> onBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    public static LayoutLeaf SliderNode<T>(ConfigEntry<T> config, UiWindow.ValueMapper<T> mapper,
        string format = "G", float width = 0f, Action<UiSlider> onBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    /// 可选 TipsButton 在最右侧。
    /// </summary>
    public static LayoutLeaf LabeledSliderNode<T>(string label, ConfigEntry<T> config, UiWindow.ValueMapper<T> mapper, string format = "G",
        int fontSize = UiPageLayout.BodyFontSize,
        string tipTitle = null, string tipContent = null,
        Action<UiSlider> onSliderBuilt = null, Action<UIButton> onTipBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    public static LayoutLeaf CheckBoxNode(ConfigEntry<bool> config, string label,
        int fontSize = UiPageLayout.BodyFontSize,
        string tipTitle = null, string tipContent = null,
        Action<UiCheckBox> onBuilt = null, Action<UIButton> onTipBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    public static LayoutLeaf CheckBoxNode(bool initialValue, string label,
        int fontSize = UiPageLayout.BodyFontSize,
        Action<UiCheckBox> onBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
        int? rowSpan = null, int? colSpan = null, string objectName = "checkbox-node") {
        return new() {
            Pos = pos, Span = span, Row = row, Col = col, RowSpan = rowSpan, ColSpan = colSpan,
            ...
            BuildAction = (wnd, root) => {
                float cellH = root.sizeDelta.y;
                float cy = cellH / 2f;
                var cb = UiCheckBox.CreateCheckBox(0f, cy, root, initialValue, label, fontSize);
                onBuilt?.Invoke(cb);
            },
        };
    }
    ...
    public static LayoutLeaf ImageButtonNode(Proto proto = null, float size = 40f,
        Action<UiImageButton> onBuilt = null,
        (int, int)? pos = null, (int, int)? span = null, int? row = null, int? col = null,
    ...
    public static void BuildLayout(UiWindow wnd, RectTransform parent, LayoutGrid root) {
