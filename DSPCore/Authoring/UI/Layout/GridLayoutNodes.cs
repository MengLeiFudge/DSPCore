...
public abstract class LayoutNode {
    ...
    internal abstract RectTransform Build(UiWindow wnd, RectTransform parent, LayoutRect rect);
}
...
public class LayoutGrid : LayoutNode {
    ...
    internal override RectTransform Build(UiWindow wnd, RectTransform parent, LayoutRect rect) {
...
public sealed class LayoutLeaf : LayoutNode {
    public LayoutInsets Padding { get; set; } = LayoutInsets.Zero;
    public Action<UiWindow, RectTransform> BuildAction { get; set; }
    internal Func<RectTransform, LayoutRect, RectTransform> RootFactory { get; set; }
