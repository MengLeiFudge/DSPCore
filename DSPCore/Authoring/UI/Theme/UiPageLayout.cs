...
/// </summary>
public static class UiPageLayout {
    ...
    public static HeaderRefs CreatePageHeader(UiWindow wnd, RectTransform parent, string title, string summary = "",
    ...
    public static Text AddCenteredText(RectTransform parent, string label, int fontSize, Color color,
        ...
        Text text = UiWindow.AddText(0f, 0f, parent, label, fontSize, objectName);
    ...
    public static RectTransform CreateCard(RectTransform parent, string objectName, float left, float top, float width,
        ...
        fillImage.sprite = UiRoundedSpriteFactory.GetFillSprite();
    ...
    private static void AddBorderOverlay(RectTransform parent, Color borderColor) {
        ...
        image.sprite = UiRoundedSpriteFactory.GetBorderSprite();
    ...
    private static void AddStrongAccent(RectTransform parent) {
        ...
        Image image = obj.GetComponent<Image>();
        image.sprite = UiRoundedSpriteFactory.GetFillSprite();
        image.type = Image.Type.Sliced;
    ...
    /// </summary>
    public static Text AddCardHeader(UiWindow wnd, RectTransform parent, string title,
        string objectName = "card-header",
        float left = CardPaddingLeft, float right = CardPaddingRight) {
        Text text = UiWindow.AddText(left, 4f, parent, title, CardTitleFontSize, $"{objectName}-title");
        text.supportRichText = true;
        text.color = Orange;
    ...
    public static Text AddCardTitle(UiWindow wnd, RectTransform parent, float left, float top, string title,
        int fontSize = CardTitleFontSize, string objectName = "card-title") {
        Text text = UiWindow.AddText(left, top, parent, title, fontSize, objectName);
        text.supportRichText = true;
        text.color = Orange;
        return text;
    }

    public static Text AddCardSummary(UiWindow wnd, RectTransform parent, float left, float top, string textValue = "",
        float width = 360f, int fontSize = BodyFontSize, string objectName = "card-summary") {
        Text text = UiWindow.AddText(left, top, parent, textValue, fontSize, objectName);
        text.supportRichText = true;
        text.color = White;
    ...
    /// </summary>
    public static Text AddEmptyStateHint(UiWindow wnd, RectTransform parent, float left, float top, float width,
        float height, string textValue = "暂无内容", string objectName = "empty-state-hint") {
        Text text = UiWindow.AddText(left, top, parent, textValue, BodyFontSize, objectName);
        text.supportRichText = true;
